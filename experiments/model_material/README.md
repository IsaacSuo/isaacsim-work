...
持续开发期间使用的 production baseline candidate、严格回归条件和审计命令见
[`docs/PRODUCTION_BASELINE_CANDIDATE.md`](../../docs/PRODUCTION_BASELINE_CANDIDATE.md)。候选基线不会把“USD 缓存可读但 PhysX 报告无效”视为成功，但它不是冻结的 M0。
