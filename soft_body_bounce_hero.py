        ...
        report.update(
            {
                ...
                "physics_material": {
                    ...
                    "max_linear_velocity": ARGS.deformable_max_linear_velocity,
                    "max_depenetration_velocity": ARGS.deformable_max_depenetration_velocity,
                    "collision_remeshing": ARGS.deformable_collision_remeshing,
                    "remeshing_resolution": ARGS.deformable_remeshing_resolution,
                    "target_triangle_count": ARGS.deformable_target_triangle_count,
                    "force_conforming": ARGS.deformable_force_conforming,
                ...
                "physics_bodies": [
                    {
                        ...
                        "collision_remeshing": body.get("collision_remeshing"),
                        "remeshing_resolution": body.get("remeshing_resolution"),
                        "target_triangle_count": body.get("target_triangle_count"),
                        "force_conforming": body.get("force_conforming"),
